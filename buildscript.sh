...
echo '\n'
echo '                                   ___  _  _ _ _    ___  ____ ____ ____ _ ___  ___ '
echo '                                 - |__] |  | | |    |  \ [__  |    |__/ | |__]  |  - '
echo '                                   |__] |__| | |___ |__/ ___] |___ |  \ | |     |   '
echo '                                               '
echo ' buildscript - a tool that automates the nmap vulnerability scanner using nse scripts     '
echo ' Ver. 1.0                                                                           '
echo ' written by: @h1_yusuf  - Hackerone.com/Yusuf_furkan                                                             '
echo '                                                                                    '
echo ' usage: ./buildscript.sh [ipadress_range] [protocol] [port] <Pn (optional)>               '
echo '\n'
